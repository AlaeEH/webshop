...
// hier stoppen we alle errors in een array
$errors = [];

// hier zetten we alle validations in de variabele $validations
$validations = [
    'required',
    'number',
    'email',
...
// hiermee kijken we of er erros zijn getroffen in de gebruikers gegevens
